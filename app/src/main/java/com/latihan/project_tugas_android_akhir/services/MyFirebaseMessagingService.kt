package com.latihan.project_tugas_android_akhir.services
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onNewToken(token: String) {
        ...
        // If you want to send messages to this specific device, you need to send this token to your server.
    }
